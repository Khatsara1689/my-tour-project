...
CREATE TABLE `Profile` (
    ...
    `avatarUrl` VARCHAR(191) NULL DEFAULT '/default-avatar.png',
...
CREATE TABLE `WishlistItem` (
    ...
    UNIQUE INDEX `WishlistItem_userId_packageId_key`(`userId`, `packageId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `WishlistItem` ADD CONSTRAINT `WishlistItem_packageId_fkey` FOREIGN KEY (`packageId`) REFERENCES `Package`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
